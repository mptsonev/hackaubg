...
<script src="js/whiteboard/canvas-designer-widget.js"></script>
...
<div id="widget-container" style="position: fixed;bottom: 0;width:100%; height: 100%;border: 1px solid black; border-top:0; border-bottom: 0;"></div>

<div id="fade" class="black_overlay"></div>

<div id="action-controls" style="width: 19%; padding: 1%;position: absolute;left:0;" hidden>
    ...
    <label for="arrow">arrow</label><br>
		...
		<input type="checkbox" id="zoom" checked>
...
//TODO DB ME! FIX
function openWhiteBoardRoom(roomid) {
...
<script src="js/whiteboard/webrtc-handler.js"></script>
<script>
function onOpenRoom() {
